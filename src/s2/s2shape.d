...
public:
  ...
  */
  ...
  /**
     ...
     These methods are intended to help with the problem of attaching additional data to S2Shape
     objects.  For example, you could return a pointer to a source object, or a pointer to a bundle
     of additional data allocated with the S2Shape.  Because this method exists in all S2Shapes, you
     can override it in each type of shape you have and call it without knowing the concrete
     subtype.  For example, if you have polyline and polygon shapes, you can do this:
