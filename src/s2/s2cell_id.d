...
public:
  ...
  /**
   * Returns the center of the cell in (u,v) coordinates (see s2coords.h).
  ...
  /**
   * Returns true if this is a leaf cell (more efficient than checking
  ...
  /**
   * Returns the cell at the previous level or at the given level (which must
  ...
  /**
   * Returns the immediate child of this cell at the given traversal order
  ...
  /**
   * Returns the next/previous cell at the same level along the Hilbert curve.
  ...
  /**
   * Returns the neighbors of closest vertex to this cell at the given level,
   ...
   */
  void appendAllNeighbors(ORangeT)(int nbr_level, ref ORangeT output) const
  ...
  /**
   * Returns a leaf cell given its cube face (range 0..5) and
  ...
  /**
   * Returns the lowest-numbered bit that is on for this cell id, which is
